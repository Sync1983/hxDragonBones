...
class Node{
	...
	public static inline function setValues(node:HelpNode, x:Float = 0, y:Float = 0, z:Int = 0, skewX:Float = 0, skewY:Float = 0, scaleX:Float = 0, scaleY:Float = 0, pivotX:Float = 0, pivotY:Float = 0) {
		node[0] = x;
		node[1] = y;
		node[2] = z;
		node[3] = scaleX;
