...
class Main_obj : public ::native::display::Sprite_obj{
	...
	public:
		...
		virtual Void onFactoryDataParsed( );
		Dynamic onFactoryDataParsed_dyn();

		virtual Void initialize( );
		Dynamic initialize_dyn();

		virtual Void onStageAddedToStage( Dynamic _);
		...
		::hxDragonBones::factorys::BaseFactory factory; /* REM */ 
};
