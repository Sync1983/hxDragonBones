...
Dynamic Lambda_obj::array( Dynamic it){
	HX_STACK_PUSH("Lambda::array","C:\\Motion-Twin\\haxe/std/Lambda.hx",35);
	HX_STACK_ARG(it,"it");
	HX_STACK_LINE(36)
...
::List Lambda_obj::list( Dynamic it){
	HX_STACK_PUSH("Lambda::list","C:\\Motion-Twin\\haxe/std/Lambda.hx",45);
	HX_STACK_ARG(it,"it");
	HX_STACK_LINE(46)
...
::List Lambda_obj::map( Dynamic it,Dynamic f){
	HX_STACK_PUSH("Lambda::map","C:\\Motion-Twin\\haxe/std/Lambda.hx",56);
	HX_STACK_ARG(it,"it");
	HX_STACK_ARG(f,"f");
	HX_STACK_LINE(57)
	::List l = ::List_obj::__new();		HX_STACK_VAR(l,"l");
...
::List Lambda_obj::mapi( Dynamic it,Dynamic f){
	HX_STACK_PUSH("Lambda::mapi","C:\\Motion-Twin\\haxe/std/Lambda.hx",66);
	HX_STACK_ARG(it,"it");
	HX_STACK_ARG(f,"f");
	HX_STACK_LINE(67)
	::List l = ::List_obj::__new();		HX_STACK_VAR(l,"l");
...
bool Lambda_obj::has( Dynamic it,Dynamic elt,Dynamic cmp){
	HX_STACK_PUSH("Lambda::has","C:\\Motion-Twin\\haxe/std/Lambda.hx",81);
	HX_STACK_ARG(it,"it");
...
bool Lambda_obj::exists( Dynamic it,Dynamic f){
	HX_STACK_PUSH("Lambda::exists","C:\\Motion-Twin\\haxe/std/Lambda.hx",97);
	HX_STACK_ARG(it,"it");
	HX_STACK_ARG(f,"f");
	HX_STACK_LINE(98)
	for(::cpp::FastIterator_obj< Dynamic > *__it = ::cpp::CreateFastIterator< Dynamic >(it->__Field(HX_CSTRING("iterator"),true)());  __it->hasNext(); ){
...
bool Lambda_obj::foreach( Dynamic it,Dynamic f){
	HX_STACK_PUSH("Lambda::foreach","C:\\Motion-Twin\\haxe/std/Lambda.hx",107);
	HX_STACK_ARG(it,"it");
	HX_STACK_ARG(f,"f");
	HX_STACK_LINE(108)
	for(::cpp::FastIterator_obj< Dynamic > *__it = ::cpp::CreateFastIterator< Dynamic >(it->__Field(HX_CSTRING("iterator"),true)());  __it->hasNext(); ){
...
{
		HX_STACK_PUSH("Lambda::iter","C:\\Motion-Twin\\haxe/std/Lambda.hx",117);
		HX_STACK_ARG(it,"it");
		HX_STACK_ARG(f,"f");
		HX_STACK_LINE(117)
		for(::cpp::FastIterator_obj< Dynamic > *__it = ::cpp::CreateFastIterator< Dynamic >(it->__Field(HX_CSTRING("iterator"),true)());  __it->hasNext(); ){
...
::List Lambda_obj::filter( Dynamic it,Dynamic f){
	HX_STACK_PUSH("Lambda::filter","C:\\Motion-Twin\\haxe/std/Lambda.hx",125);
	HX_STACK_ARG(it,"it");
	HX_STACK_ARG(f,"f");
	HX_STACK_LINE(126)
	::List l = ::List_obj::__new();		HX_STACK_VAR(l,"l");
...
Dynamic Lambda_obj::fold( Dynamic it,Dynamic f,Dynamic first){
	HX_STACK_PUSH("Lambda::fold","C:\\Motion-Twin\\haxe/std/Lambda.hx",136);
	HX_STACK_ARG(it,"it");
	HX_STACK_ARG(f,"f");
...
int Lambda_obj::count( Dynamic it,Dynamic pred){
	HX_STACK_PUSH("Lambda::count","C:\\Motion-Twin\\haxe/std/Lambda.hx",145);
	HX_STACK_ARG(it,"it");
...
bool Lambda_obj::empty( Dynamic it){
	HX_STACK_PUSH("Lambda::empty","C:\\Motion-Twin\\haxe/std/Lambda.hx",160);
	HX_STACK_ARG(it,"it");
	HX_STACK_LINE(160)
...
int Lambda_obj::indexOf( Dynamic it,Dynamic v){
	HX_STACK_PUSH("Lambda::indexOf","C:\\Motion-Twin\\haxe/std/Lambda.hx",168);
	HX_STACK_ARG(it,"it");
	HX_STACK_ARG(v,"v");
	HX_STACK_LINE(169)
	int i = (int)0;		HX_STACK_VAR(i,"i");
...
::List Lambda_obj::concat( Dynamic a,Dynamic b){
	HX_STACK_PUSH("Lambda::concat","C:\\Motion-Twin\\haxe/std/Lambda.hx",181);
	HX_STACK_ARG(a,"a");
	HX_STACK_ARG(b,"b");
	HX_STACK_LINE(182)
	::List l = ::List_obj::__new();		HX_STACK_VAR(l,"l");
