...
int Stats_obj::normalizeMem( Float _mem){
	HX_STACK_PUSH("Stats::normalizeMem","com/fermmmtools/debug/Stats.hx",186);
	HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("Stats::update","com/fermmmtools/debug/Stats.hx",124);
		HX_STACK_THIS(this);
		HX_STACK_ARG(e,"e");
		HX_STACK_LINE(126)
...
{
		HX_STACK_PUSH("Stats::destroy","com/fermmmtools/debug/Stats.hx",111);
		HX_STACK_THIS(this);
		HX_STACK_ARG(e,"e");
		HX_STACK_LINE(113)
...
{
		HX_STACK_PUSH("Stats::init","com/fermmmtools/debug/Stats.hx",92);
		HX_STACK_THIS(this);
		HX_STACK_ARG(e,"e");
		HX_STACK_LINE(94)
...
{
	Static(__mClass) = hx::RegisterClass(HX_CSTRING("com.fermmmtools.debug.Stats"), hx::TCanCast< Stats_obj> ,sStaticFields,sMemberFields,
