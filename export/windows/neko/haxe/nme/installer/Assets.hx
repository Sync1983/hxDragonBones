...
class Assets {
	...
	private static function initialize ():Void {
		...
		if (!initialized) {
			...
			resourceNames.set ("assets/img/character_output.png", "assets/img/character_output.png");
			resourceTypes.set ("assets/img/character_output.png", "image");
			resourceNames.set ("assets/img/character_output_bin", "assets/img/character_output_bin");
